...
export function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-10 bg-base-background bg-opacity-95 ">
      <div className="max-w-6xl m-auto flex justify-between items-center h-28">
        <Link to="/">
